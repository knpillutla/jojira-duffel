...
class AISearchRequest(BaseModel):
    ...
    from_date: Optional[str] = Field(None, description="Override extracted start date YYYY-MM-DD")
    to_date: Optional[str] = Field(None, description="Override extracted end date YYYY-MM-DD")
    min_price: Optional[float] = Field(None, ge=0, description="Override extracted minimum price constraint")
